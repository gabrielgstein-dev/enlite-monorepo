...
1. `docs/PROJECT_CONTEXT.md` — arquitetura, stack, estrutura de pastas
2. `docs/DECISIONS.md` — decisões técnicas já tomadas (não reinvente)
3. `docs/CONVENTIONS.md` — padrões de nomenclatura e estrutura do projeto
