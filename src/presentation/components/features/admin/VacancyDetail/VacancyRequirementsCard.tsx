    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center">
          <Typography variant="body" className="text-[#737373]">Sexo requerido</Typography>
          <Typography variant="body" weight="medium">{llmRequiredSex ?? '—'}</Typography>
        </div>
        <div className="flex justify-between items-start">
          <Typography variant="body" className="text-[#737373]">Profissões</Typography>
          <ChipList items={llmRequiredProfession ?? []} />
        </div>
        <div className="flex justify-between items-start">
          <Typography variant="body" className="text-[#737373]">Especialidades</Typography>
          <ChipList items={llmRequiredSpecialties ?? []} />
        </div>
        <div className="flex justify-between items-start">
          <Typography variant="body" className="text-[#737373]">Diagnósticos requeridos</Typography>
