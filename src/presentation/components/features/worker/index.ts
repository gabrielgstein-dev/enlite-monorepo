// Nota: MainSidebar foi movido para @presentation/components/templates/DashboardLayout/MainSidebar
// pois é um componente global de layout

export { WorkerTopNavbar } from './WorkerTopNavbar';
